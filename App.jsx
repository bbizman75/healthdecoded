...
const TRANSLATIONS = {
  EN: {
    ...
    subtitle: "Personalised health analysis",
    // Tab descriptions
    ...
    tab2Desc: "Tell us your symptoms, medications, allergies, and health history. We cross-reference everything — patterns that would take 3 appointments to uncover — and give you a complete action plan with urgency scoring, OTC guidance checked against your allergies and drugs, and the exact questions to ask your doctor at your next appointment.",
    tab2Tag: "Most complete",
    tab2Includes: ["Urgency score 1–5 — know when to act NOW","OTC guidance with allergy & drug interaction check","Symptoms + timeline — all cross-referenced","Specific action cards: medicine, diet, lifestyle, doctor","Questions pre-written for your pharmacist and doctor","Personalised supplement recommendations"],
    ...
    tryAgain: "Try again",
    // Footer
    footerNote: "Personalised health analysis · For sound decisions · Always consult your doctor",
    // Upsell
    upsellLabTitle: "Want a complete health picture?",
    upsellLabDesc: "Your lab report is on its way. For a deeper analysis that combines your symptoms, medications, allergies and health history — get a Full Health Consultation.",
    upsellLabBtn: "→ Start Full Health Consultation",
    upsellConsultTitle: "Want even deeper insights?",
    upsellConsultDesc: "Your consultation report is on its way. For a full biomarker-by-biomarker breakdown, upload your blood test results — we'll explain every value in detail.",
    upsellConsultBtn: "→ Analyse my Lab Results",
    // Supplement guide
    suppGuideSubtitle: "Universal foundations first, then age-specific and sex-specific. Not a prescription — discuss with your pharmacist or doctor.",
    suppYourProfile: "your section is highlighted",
    suppUniversalTitle: "Universal Foundations",
    suppUniversalSub: "All ages · All sexes · Recommended for virtually everyone",
    suppYourAgeGroup: "← Your age group",
    suppMainFocus: "What's your main focus?",
    suppNoResults: "No specific supplements for this focus in this age group.",
    suppTryAll: 'Try "All" to see everything.',
    suppBothSexes: "👥 Both sexes",
    suppReminder: "Always check with a pharmacist or doctor before starting supplements, especially if you take medications. This is not a prescription.",
  },
  FR: {
    // Nav
    ...
    subtitle: "Analyse de santé personnalisée",
    // Tab descriptions
    ...
    tab2Desc: "Dites-nous vos symptômes, médicaments, allergies et antécédents. Nous croisons tout — des patterns qui nécessiteraient 3 consultations — et vous donnons un plan d'action complet avec score d'urgence, conseils OTC vérifiés contre vos allergies et traitements, et les questions exactes à poser à votre médecin lors de votre prochain rendez-vous.",
    tab2Tag: "Le plus complet",
    tab2Includes: ["Score d'urgence 1–5 — savoir quand agir MAINTENANT","Conseils OTC avec vérification allergies et interactions","Symptômes + timeline — tout croisé","Fiches d'action : médicament, alimentation, style de vie, médecin","Questions pré-rédigées pour votre pharmacien et médecin","Recommandations de compléments personnalisées"],
    ...
    tryAgain: "Réessayer",
    // Footer
    footerNote: "Analyse de santé personnalisée · Pour des décisions éclairées · Consultez toujours votre médecin",
    // Upsell
    upsellLabTitle: "Vous voulez une vision complète de votre santé ?",
    upsellLabDesc: "Votre rapport de bilan est en route. Pour une analyse plus approfondie combinant vos symptômes, médicaments, allergies et antécédents — faites une Consultation complète.",
    upsellLabBtn: "→ Démarrer une Consultation complète",
    upsellConsultTitle: "Vous voulez des insights encore plus profonds ?",
    upsellConsultDesc: "Votre rapport de consultation est en route. Pour une analyse biomarqueur par biomarqueur, importez vos résultats de bilan sanguin — nous expliquerons chaque valeur en détail.",
    upsellConsultBtn: "→ Analyser mon Bilan Sanguin",
    // Supplement guide
    suppGuideSubtitle: "Fondations universelles d'abord, puis spécifiques à l'âge et au sexe. Pas une ordonnance — discutez avec votre pharmacien ou médecin.",
    suppYourProfile: "votre section est mise en évidence",
    suppUniversalTitle: "Fondations Universelles",
    suppUniversalSub: "Tous âges · Les deux sexes · Recommandé pour pratiquement tout le monde",
    suppYourAgeGroup: "← Votre tranche d'âge",
    suppMainFocus: "Quel est votre objectif principal ?",
    suppNoResults: "Aucun complément spécifique pour cet objectif dans cette tranche d'âge.",
    suppTryAll: "Essayez \"Tout\" pour tout voir.",
    suppBothSexes: "👥 Les deux sexes",
    suppReminder: "Consultez toujours un pharmacien ou un médecin avant de commencer des compléments, surtout si vous prenez des médicaments. Ceci n'est pas une ordonnance.",
  }
};
...
Return ONLY valid JSON. No markdown.`;
      ...
      <div>
        ...
        <div style={{ background:"linear-gradient(135deg,#0f172a,#1e3a5f)", borderRadius:16, padding:"28px 24px", marginBottom:24, color:"#fff" }}>
          ...
          <h2 style={{ fontSize:22, fontWeight:800, color:"#fff", marginBottom:10, lineHeight:1.3 }}>
            {tx("heroTitle1")}<br/>
            <span style={{ color:"#7dd3fc" }}>{tx("heroTitle2")}</span>
          </h2>
 ...
 const generatePreview = async (tab) => {
  ...
  const renderPaymentGate = () => {
    ...
    const price = isLab ? "€4.90" : "€9.90";
    const includes = isLab
      ? ["Every biomarker explained in full","Optimal vs reference range","Specific OTC & diet actions","Retest roadmap","PDF sent to your email"]
        ...
        <div style={{ marginBottom:20 }}>
          ...
          {age && sex && (
            <div style={{ fontSize:13, fontWeight:700, color:"#16a34a", background:"#f0fdf4", border:"1px solid #86efac", borderRadius:8, padding:"7px 12px", display:"inline-block" }}>
              ✓ Your profile: {sex}, age {age} — {tx("suppYourProfile")}
            </div>
          )}
        </div>
        ...
        {ageFilter === "All" && (
          <div style={{ marginBottom:24 }}>
            <div style={{ background:"#1e293b", borderRadius:12, padding:"12px 16px", marginBottom:12, display:"flex", alignItems:"center", gap:8 }}>
              ...
              <div>
                <div style={{ fontSize:15, fontWeight:800, color:"#fff" }}>{tx("suppUniversalTitle")}</div>
                <div style={{ fontSize:12, color:"#94a3b8" }}>{tx("suppUniversalSub")}</div>
              </div>
            </div>
            <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
              ...
              <div key={ageGroup} style={{
                ...
                <div style={{ background:am.bg, padding:"13px 18px", display:"flex", alignItems:"center", gap:10 }}>
                  ...
                  <div>
                    ...
                    {isUserGroup && <div style={{ fontSize:11, fontWeight:700, color:am.color, opacity:0.75 }}>{tx("suppYourAgeGroup")}</div>}
                  </div>
                </div>
                ...
                <div style={{ padding:"14px 16px", background:"#fff" }}>
                  {bothSexes.length === 0 && maleOnly.length === 0 && femaleOnly.length === 0 && (
                    <div style={{ fontSize:13, color:"#94a3b8", textAlign:"center", padding:"16px 0" }}>
                      {tx("suppNoResults")}
                      <br /><span style={{ fontSize:12 }}>{tx("suppTryAll")}</span>
                    </div>
                  )}
                  {bothSexes.length > 0 && (
                    <div style={{ marginBottom:14 }}>
  ...
  Health<span style={{ color:"#0ea5e9" }}>Decoded</span>
      ...
      <div style={{ maxWidth:680, margin:"0 auto" }}>
        ...
        {lang === "FR" && (
          <div style={{
            ...
            <div style={{ fontSize:13, color:"#92400e", lineHeight:1.5 }}>
              💡 <strong>Meilleure expérience en français :</strong> utilisez la traduction automatique de Chrome — cliquez sur l'icône de traduction dans votre barre d'adresse.
            </div>
            <button onClick={toggleLang} style={{
          ...
          <div style={{
            ...
            {paymentReturn.status === "paid" ? (
              <>
                ...
                {paymentReturn.type === "lab" ? (
                  <div style={{ marginTop:20, padding:"20px 24px", background:"#faf5ff", border:"2px solid #7c3aed", borderRadius:14 }}>
                    <div style={{ fontSize:16, fontWeight:800, color:"#7c3aed", marginBottom:8 }}>
                      🩺 {tx("upsellLabTitle")}
                    </div>
                    <div style={{ fontSize:14, color:"#1e293b", lineHeight:1.7, marginBottom:14 }}>
                      {tx("upsellLabDesc")}
                    </div>
                    <button onClick={() => { setPaymentReturn(null); setMainTab(1); }} style={{
                  ...
                  <div style={{ marginTop:20, padding:"20px 24px", background:"#f0f9ff", border:"2px solid #0369a1", borderRadius:14 }}>
                    <div style={{ fontSize:16, fontWeight:800, color:"#0369a1", marginBottom:8 }}>
                      🔬 {tx("upsellConsultTitle")}
                    </div>
                    <div style={{ fontSize:14, color:"#1e293b", lineHeight:1.7, marginBottom:14 }}>
                      {tx("upsellConsultDesc")}
                    </div>
                    <button onClick={() => { setPaymentReturn(null); setMainTab(0); }} style={{
                      width:"100%", padding:"13px", borderRadius:10, border:"none",
                      background:"#0369a1", color:"#fff", fontWeight:800, fontSize:15,
                      cursor:"pointer", fontFamily:"inherit"
                    }}>
                      {tx("upsellConsultBtn")}
                    </button>
                  ...
                  <div style={{ padding:"14px 18px" }}>
                    ...
                    <div style={{ marginTop:14, textAlign:"center" }}>
                      <button
                        ...
                        {i === 2 ? tx("browseGuide") : `${tx("startFor")} ${tab.price} →`}
                      </button>
                    </div>
                  </div>
                )}
        ...
        <div style={{ textAlign:"center", marginTop:16, fontSize:11, color:"#94a3b8" }}>
          <strong style={{ color:"#0ea5e9" }}>HealthDecoded</strong> · healthdecoded.com · {tx("footerNote")} · <a href="mailto:healthdecoded.help@gmail.com" style={{ color:"#0ea5e9", textDecoration:"none" }}>healthdecoded.help@gmail.com</a>
        </div>
      </div>
      </div>
    </div>
