...
Generate a comprehensive health report. Return ONLY this JSON (no markdown):
{
  ...
  "retestPlan": {
    ...
    "expectedImprovements": "With proper nutrition and lifestyle adjustments, immune markers typically normalize within 6-8 weeks"
      ...
      : `You are an AI health consultant. Based on this consultation preview: "${teaser}", generate a health report. Return ONLY valid JSON, no markdown: {"urgency":{"level":2,"label":"Book appointment within 2-4 weeks","color":"yellow","message":"Your symptoms indicate patterns worth investigating. No immediate emergency.","showActions":true},"summary":"Based on your consultation, several patterns have been identified that warrant attention.","healthScore":{"metabolic":65,"weight":70,"sleep":60,"overall":65},"actionCards":[{"finding":"Symptom Pattern Analysis","severity":"borderline","explanation":"Your reported symptoms show interconnected patterns common when the body is under stress or nutritional imbalance.","actions":[{"type":"lifestyle","title":"Establish consistent sleep schedule","detail":"Go to bed and wake at the same time daily. Poor sleep amplifies almost every other symptom."},{"type":"diet","title":"Anti-inflammatory nutrition","detail":"Reduce processed foods, increase omega-3 rich foods and colorful vegetables."},{"type":"doctor","title":"Book a comprehensive check-up","detail":"Request a full blood panel including CBC, thyroid, vitamin D, B12, ferritin, glucose and CRP."}],"retestIn":"6-8 weeks"}],"concerns":[{"name":"Nutritional deficiencies","confidence":"Medium","reasoning":"Symptom patterns consistent with common deficiencies including vitamin D, iron, B12 or magnesium."}],"suggestedTests":[{"test":"Full blood count (CBC)","reason":"Baseline for all blood cell levels"},{"test":"Thyroid panel","reason":"Affects energy, weight and mood"},{"test":"Vitamin D","reason":"Deficiency extremely common"},{"test":"Ferritin","reason":"Low ferritin causes fatigue even without anaemia"}],"doctorQuestions":["Could my symptoms relate to a nutritional deficiency?","Would you recommend a full blood panel?","Are there lifestyle changes you would prioritize?"],"homeEssentials":[{"item":"Vitamin D3 + K2","reason":"Impacts energy, immunity and mood"},{"item":"Magnesium glycinate","reason":"Supports sleep and stress response"},{"item":"Omega-3 fish oil","reason":"Anti-inflammatory, supports brain and heart"}]}`;
