          ...
          <div style={{
            ...
            {paymentReturn.status === "paid" ? (
              <>
                ...
                <div style={{ marginTop:16, padding:"14px 16px", background:"#fff", border:"1.5px solid #bae6fd", borderRadius:12 }}>
                  <div style={{ fontSize:13, color:"#0369a1", lineHeight:1.6 }}>
                    💡 <strong>Want even deeper insights?</strong> We recommend uploading your blood test results — details are in your report.{" "}
                    <button onClick={() => { setPaymentReturn(null); setMainTab(0); }} style={{ background:"none", border:"none", color:"#0369a1", fontWeight:700, textDecoration:"underline", cursor:"pointer", fontSize:13, fontFamily:"inherit" }}>
